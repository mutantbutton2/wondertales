...
public class LittlePigOneScoringStrategy implements ScoringStrategy {

    private static final Set<Character> characterSet = Set.of(new LittlePigOne(), new LittlePigTwo(), new LittlePigThree());
